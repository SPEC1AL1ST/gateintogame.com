            ...
            <div class="main-left-block-container cf">
                ...
                <div class="main-left-block-about-our-shop-container cf">
                    <div class="main-left-block-about-our-shop-container-hidden">
                        <h1>Немного о нас</h1>
                        <h1 class="main-left-block-about-our-shop-header">Гипермаркет GateIntoGame<span> - сервис по продаже внутриигровых ценностей и оказанию различного вида услуг в онлайн играх жанра MMORPG. Мы предоставляем возможность купить валюту в онлайн игре (такую как золото, ISK), оплату (например PLEX в EVE Online или жетоны ArcheAge), заказать прокачку персонажей, услугу гаранта сделки и многое другое для приятного отдыха в любимой игре без забот.</span></h1>
                        <p class="main-left-block-about-our-shop-text">Мы предоставляем качественные услуги с 2006г,
                            заботимся о максимальной безопасности клиентов, нас отличает очень быстрая доставка, а так же
                            приятные цены!</p>
